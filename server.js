...
app.get("/api/models", limiter, validateApiKey, async (req, res) => {
  try {
...
// Agents endpoint
app.post("/api/agents", limiter, validateApiKey, async (req, res) => {
...
// Get agents
app.get("/api/agents", limiter, validateApiKey, (req, res) => {
  res.json({ agents: [], total: 0 });
});

// Chat with agent
app.post("/api/agents/:id/chat", limiter, validateApiKey, async (req, res) => {
...
// Get tools
app.get("/api/tools", limiter, validateApiKey, (req, res) => {
  res.json({
    available_tools: [
